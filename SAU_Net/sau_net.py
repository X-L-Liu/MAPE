...
class SubMiddle(nn.Module):
    def __init__(self, channels, init_channels, highest, pre_subMiddle, self_att):
        ...
        self.skip = SelfAttn(channels) if self_att else SplitAdd()
...
class SAU_Net(nn.Module):
    ...
    Args:
        ...
        self_attention (str, optional): True or False. Default: True

    """

    def __init__(self, in_channels=3, out_channels=3, init_conv_channels=32, num_down=5, self_attention=True):
        super().__init__()
